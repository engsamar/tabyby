        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('clinics.update', $clinic->id) }}" method="POST">
                ...
                <div class="form-group @if($errors->has('name')) has-error @endif">
                    ...
                    <input type="text" id="telephone-field" name="telephone" class="form-control" value="{{ $clinic->telephone }}"/>
                    ...
                    <input type="text" id="address-field" name="address" class="form-control" value="{{ $clinic->address }}"/>
