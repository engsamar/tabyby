...
@section('header')
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-edit"></i> Consistitues / Edit #{{$consistitue->id}}</h1>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{ route('consistitues.update', $consistitue->id) }}" method="POST">
                ...
                <div class="form-group @if($errors->has('active_consistitue')) has-error @endif">
                    ...
                    <input type="text" id="active_consistitue-field" name="active_consistitue" class="form-control" value="{{ $consistitue->active_consistitue }}"/>
