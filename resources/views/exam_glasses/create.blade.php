        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('exam_glasses.store') }}" method="POST">
                ...
                <div class="form-group @if($errors->has('sphr')) has-error @endif">
                    ...
                    <input type="text" id="sphr-field" name="sphr" class="form-control" value="{{ old("sphr") }}"/>
                       @if($errors->has("sphr"))
                    ...
                    <input type="text" id="cylr-field" name="cylr" class="form-control" value="{{ old("cylr") }}"/>
                       @if($errors->has("cylr"))
                    ...
                    <input type="text" id="axisr-field" name="axisr" class="form-control" value="{{ old("axisr") }}"/>
                       @if($errors->has("axisr"))
                    ...
                    <input type="text" id="sphl-field" name="sphl" class="form-control" value="{{ old("sphl") }}"/>
                       @if($errors->has("sphl"))
                    ...
                    <input type="text" id="cyll-field" name="cyll" class="form-control" value="{{ old("cyll") }}"/>
                       @if($errors->has("cyll"))
                    ...
                    <input type="text" id="axisl-field" name="axisl" class="form-control" value="{{ old("axisl") }}"/>
                       @if($errors->has("axisl"))
                    ...
                    <input type="text" id="reservation_id-field" name="reservation_id" class="form-control" value="{{ old("reservation_id") }}"/>
