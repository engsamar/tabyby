        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('examinations.store') }}" method="POST">
                ...
                <div class="form-group @if($errors->has('eye_type')) has-error @endif">
                    ...
                    <input type="text" id="vision-field" name="vision" class="form-control" value="{{ old("vision") }}"/>
                    ...
                    <input type="text" id="conjunctiva-field" name="conjunctiva" class="form-control" value="{{ old("conjunctiva") }}"/>
                    ...
                    <input type="text" id="cornea-field" name="cornea" class="form-control" value="{{ old("cornea") }}"/>
                    ...
                    <input type="text" id="fundus-field" name="fundus" class="form-control" value="{{ old("fundus") }}"/>
