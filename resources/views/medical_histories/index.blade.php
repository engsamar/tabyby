...
@section('header')
    <div class="page-header clearfix">
        <h1>
            ...
            <a class="btn btn-success pull-right" href="{{ route('medical_histories.create') }}"><i class="glyphicon glyphicon-plus"></i> Create</a>
        </h1>
            ...
            @if($medical_histories->count())
                <table class="table table-condensed table-striped">
                    ...
                    <td>{{$medical_history->begin_at}}</td>
                                <td class="text-right">
                                    <a class="btn btn-xs btn-primary" href="{{ route('medical_histories.show', $medical_history->id) }}"><i class="glyphicon glyphicon-eye-open"></i> View</a>
                                    <a class="btn btn-xs btn-warning" href="{{ route('medical_histories.edit', $medical_history->id) }}"><i class="glyphicon glyphicon-edit"></i> Edit</a>
