...
@section('header')
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-edit"></i> PerceptionDetails / Edit #{{$perception_detail->id}}</h1>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{ route('perception_details.update', $perception_detail->id) }}" method="POST">
                ...
                <div class="form-group @if($errors->has('medicine_name')) has-error @endif">
                    ...
                    <input type="text" id="medicine_name-field" name="medicine_name" class="form-control" value="{{ $perception_detail->medicine_name }}"/>
                    ...
                    <input type="text" id="no_times-field" name="no_times" class="form-control" value="{{ $perception_detail->no_times }}"/>
                    ...
                    <input type="text" id="quantity-field" name="quantity" class="form-control" value="{{ $perception_detail->quantity }}"/>
                    ...
                    <input type="text" id="duration-field" name="duration" class="form-control" value="{{ $perception_detail->duration }}"/>
                    ...
                    <input type="text" id="preception_id-field" name="preception_id" class="form-control" value="{{ $perception_detail->preception_id }}"/>
