        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('working_hours.store') }}" method="POST">
                ...
                <div class="form-group @if($errors->has('from')) has-error @endif">
                    ...
                    <input type="text" id="from-field" name="from" class="form-control date-picker" value="{{ old("from") }}"/>
                       @if($errors->has("from"))
                    ...
                    <input type="text" id="to-field" name="to" class="form-control date-picker" value="{{ old("to") }}"/>
                       @if($errors->has("to"))
                    ...
                    <input type="text" id="day-field" name="day" class="form-control date-picker" value="{{ old("day") }}"/>
                       @if($errors->has("day"))
